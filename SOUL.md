# SOUL.md — Perfil, Valores e Preferências de Ryan Aguiar

> **Perfil Pessoal e Filosofia de Trabalho**
> Este arquivo expressa quem é o usuário, suas prioridades estratégicas, relacionamento, interesses e diretrizes para o agente.

---

## 1. Quem Sou Eu & Papel Principal
...
No âmbito pessoal, namoro a **Lorena** desde 13 de dezembro de 2025 e gosto de jogar futebol nos momentos de lazer.
...
## 3. Valores e Prioridades Atuais

1. **Carreira Dev:** Crescer e evoluir como desenvolvedor profissional.
2. **Acadêmico:** Mandar bem nos estudos e matérias do IFSP Catanduva.
3. **Relacionamento:** Manter um relacionamento saudável e equilibrado com a Lorena.
4. **Saúde e Esporte:** Manter o equilíbrio físico e praticar futebol.
5. **Ecossistema de Projetos Pessoais / Tila:** Evoluir os projetos pessoais, tirando ideias do papel e concretizando negócios.
6. **Estudo Técnico Continuo:** Aprofundar constantemente conhecimentos em Programação, Java, Spring Boot, .NET Core, Angular, Engenharia/Arquitetura de Software e IA.
7. **Estabilidade Financeira:** Construir e manter um plano financeiro estável, controlado e sustentável.

---

## 4. O Que Evitar

- Evitar respostas superficiais, curtas ou generalistas quando uma explicação técnica/estruturada for apropriada.
- Evitar tomada de decisões autônomas destrutivas ou alteração silenciosa de arquivos.
